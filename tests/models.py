...
class Account(Base):
    ...
    __colanderalchemy_config__ = {"preparer": "DummyPreparer", "unknown": "raise"}
...
class Person(Base):
    ...
    __colanderalchemy_config__ = {"widget": "DummyWidget", "title": "Person Object"}
...
class Group(Base):
    ...
    leader = relationship("Person", uselist=False, innerjoin=True, secondary="group_associations")
    executive = relationship("Person", uselist=True, innerjoin=True, secondary="group_associations")
    members = relationship("Person", uselist=True, secondary="group_associations")
